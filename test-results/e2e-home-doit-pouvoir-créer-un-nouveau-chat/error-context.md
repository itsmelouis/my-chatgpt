...
- Name: doit pouvoir créer un nouveau chat
- Location: /Users/louis/dev/school/my-chatgpt/tests/e2e/home.spec.ts:19:1
...
Call log:
  - waiting for getByRole('button', { name: /nouveau chat/i })

    at /Users/louis/dev/school/my-chatgpt/tests/e2e/home.spec.ts:24:61
```
